...
create_clock -period 10.000 -name reset -waveform {0.000 5.000} [get_ports reset]
create_clock -period 10.000 -name {switch[0]} -waveform {0.000 5.000} [get_ports {switch[0]}]
